...
const newRegex1 = `<option value="folder_null" style={{color: 'var(--accent)', fontWeight: 'bold'}}>+ Thêm Chưa phân loại</option>`;
...
const newRegex2 = `<option value={\`folder_\${folder.id}\`} style={{color: 'var(--accent)', fontWeight: 'bold'}}>+ Thêm {folder.name}</option>`;
